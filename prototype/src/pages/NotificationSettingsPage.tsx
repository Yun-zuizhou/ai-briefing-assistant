...
export default function NotificationSettingsPage() {
  ...
  const [timeSlots, setTimeSlots] = useState<TimeSlot[]>([
    { id: 'morning', label: '晨间简报', time: pushTime, enabled: true },
  ...
  const handleSave = useCallback(async () => {
    try {
      setError(null);
      const morning = timeSlots.find((slot) => slot.id === 'morning')?.time || pushTime;
  ...
  }, [dndEnd, dndStart, doNotDisturb, pushTime, setPushTime, soundEnabled, timeSlots, vibrationEnabled]);
