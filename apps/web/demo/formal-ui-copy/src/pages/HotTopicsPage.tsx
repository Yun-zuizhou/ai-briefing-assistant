                ...
                {visibleTopics.map((topic, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className="type-content-title" style={{
                        fontSize: '14px',
                        color: 'var(--ink)',
                        marginBottom: '8px',
                      }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', position: 'relative' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--ink)', fontFamily: 'var(--font-sans-cn)' }}>
                热点详情
              </h3>
              <button
            ...
            <h4 className="type-content-title" style={{
              fontSize: '15px',
              color: 'var(--ink)',
              marginBottom: '12px',
            }}>
            ...
            <div style={{
              ...
              marginBottom: '16px',
                ...
                <p style={{ fontSize: '12px', color: 'var(--ink-muted)', margin: 0, lineHeight: 1.7 }}>
