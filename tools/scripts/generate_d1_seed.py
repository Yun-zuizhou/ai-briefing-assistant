...
OUTPUT_SQL = ROOT / "infra" / "cloudflare" / "d1" / "seeds" / "generated" / "seed.generated.sql"
        ...
        if isinstance(settings, dict):
            statements.extend(insert_sql(
                ...
                [{
                    ...
                    "morning_brief_time": settings.get("morning_brief_time") or settings.get("morning_briefing_time", "08:00"),
                    "evening_brief_time": settings.get("evening_brief_time") or settings.get("evening_briefing_time", "21:00"),
                    "do_not_disturb_enabled": 1 if settings.get("do_not_disturb_enabled") else 0,
                    "do_not_disturb_start": settings.get("do_not_disturb_start"),
                    "do_not_disturb_end": settings.get("do_not_disturb_end"),
                    "sound_enabled": 1 if settings.get("sound_enabled", True) else 0,
                    "vibration_enabled": 1 if settings.get("vibration_enabled", True) else 0,
